...
BOARD_RECOVERY_DTBO_SIZE := 171796
BOARD_RECOVERY_DTBO_OFFSET := 27879424
BOARD_HEADER_SIZE := 1660
BOARD_DTB_SIZE := 104647
...
TW_INCLUDE_FBE_CRYPTO := true
TW_NO_SCREEN_BLANK := true
TW_SCREEN_BLANK_ON_BOOT := true
TW_INCLUDE_REPACKTOOLS := true
TW_INCLUDE_RESETPROP := true
TW_INCLUDE_LIBRESETPROP := true
TW_INCLUDE_LIBPURESOFTKEYMASTERDEVICE := true
TW_HAS_MTP := true
TW_INCLUDE_RESETPROP := true
TW_NEVER_UNMOUNT_SYSTEM := true
TW_INCLUDE_FBE_METADATA_DECRYPT := true
TW_INCLUDE_FBE_DATA_DECRYPT := true
